...
import com.obatis.db.constant.type.*;
import com.obatis.db.convert.BeanCacheConvert;
import com.obatis.exception.HandleException;
import com.obatis.db.sql.mysql.HandleOrderMethod;
...
public class QueryProvider {
	...
	public QueryProvider setPageSize(int page) {
		this.pageSize = page;
		return this;
	}

	public QueryProvider setPage(int page, int rows) {
