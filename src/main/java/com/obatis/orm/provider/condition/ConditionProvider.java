...
public interface ConditionProvider {
     ...
     * @param value
     */
    AbstractConditionProvider orLessEqual(String filterName, Object value);
     ...
     * @param pattern
     */
    AbstractConditionProvider orLessEqualDateFormat(String filterName, Object value, String pattern);
     ...
     * @param fieldName
     */
    AbstractConditionProvider orLessEqualField(String filterName, String fieldName);
     ...
     * @param value
     */
    AbstractConditionProvider notEqual(String filterName, Object value);
     ...
     * @param pattern
     */
    AbstractConditionProvider notEqualDateFormat(String filterName, Object value, String pattern);
     ...
     * @param fieldName
     */
    AbstractConditionProvider notEqualField(String filterName, String fieldName);
     ...
     * @param value
     */
    AbstractConditionProvider orNotEqual(String filterName, Object value);
     ...
     * @param pattern
     */
    AbstractConditionProvider orNotEqualDateFormat(String filterName, Object value, String pattern);
     ...
     * @param fieldName
     */
    AbstractConditionProvider orNotEqualField(String filterName, String fieldName);
     ...
     * @param value
     */
    AbstractConditionProvider in(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider orIn(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider notIn(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider orNotIn(String filterName, Object value);
     ...
     * @param provider
     */
    AbstractConditionProvider inProvider(String filterName, QueryProvider provider);
     ...
     * @param provider
     */
    AbstractConditionProvider orInProvider(String filterName, QueryProvider provider);
     ...
     * @param provider
     */
    AbstractConditionProvider notInProvider(String filterName, QueryProvider provider);
     ...
     * @return
     */
    AbstractConditionProvider orNotInProvider(String filterName, QueryProvider provider);

    /**
     * and 查询条件，表示null值查询，is null
     * @param filterName
     */
    AbstractConditionProvider isNull(String filterName);

    /**
     * or 查询条件，表示null值查询，is null
     * @param filterName
     */
    AbstractConditionProvider orIsNull(String filterName);

    /**
     * and 查询条件，表示null值查询，is not null
     * @param filterName
     */
    AbstractConditionProvider isNotNull(String filterName);

    /**
     * or 查询条件，表示null值查询，is not null
     * @param filterName
     */
    AbstractConditionProvider orIsNotNull(String filterName);
     ...
     * @param value
     */
    AbstractConditionProvider upGreaterThanZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider orUpGreaterThanZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider upGreaterEqualZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider orUpGreaterEqualZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider reduceGreaterThanZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider orReduceGreaterThanZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider reduceGreaterEqualZero(String filterName, Object value);
     ...
     * @param value
     */
    AbstractConditionProvider orReduceGreaterEqualZero(String filterName, Object value);
     ...
     * @param queryProvider
     */
    AbstractConditionProvider addProvider(QueryProvider queryProvider);
     ...
     * @param queryProvider
     */
    AbstractConditionProvider addProvider(QueryProvider queryProvider, JoinTypeEnum joinTypeEnum);
     ...
     * @param rows
     */
    QueryProvider setLimit(int rows);
     ...
     * @param obj
     */
    AbstractConditionProvider setFilters(Object obj);

    /**
     * 移除所有条件，方便对象复用，但是要确保对象已经被消费
     * @param
     */
    AbstractConditionProvider reset();
}
